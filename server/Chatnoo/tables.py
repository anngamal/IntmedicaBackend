    ...
    with app.app_context():
        ...
        for product_elem in soup.find_all(class_="product details product-item-details"):
            ...
            if a_tag is not None:
                ...
                tablesProduct = Tables(name=product_name, price=product_price, href=product_href, image=image_url, description=description_text)
                db.session.add(tablesProduct)
                db.session.commit()
                print(tablesProduct)



base_url = "https://www.chattanoogarehab.com/us/tables-traction?p="
