...
from model import db, Shockwave
import requests
    ...
    with app.app_context():
        ...
        for product_elem in soup.find_all(class_="product details product-item-details"):
            ...
            if a_tag is not None:
                ...
                shockwaveProduct = Shockwave(name=product_name, price=product_price, href=product_href, image=image_url, description=description_text)
                db.session.add(shockwaveProduct)
                db.session.commit()
                print(shockwaveProduct)


base_url = "https://www.chattanoogarehab.com/us/shock-wave-rpw?p="
