...
with app.app_context():
    ...
    url = "https://www.therabody.com/us/en-us/products/?prefn1=productTypeMasterPLP&prefv1=smartgoggles"
        ...
        for a_tag in product_elem.find_all("a", class_="name-link", href=True):
            ...
            try:
                ...
                product_list.append({
                    ...
                    "image":image_url,
                    "category":"Smartgoggles",  
                    "brand":"Therabody" 
                    
                    
                })

                smartgogglesProduct = Smartgoggles(name=product_name, price=product_price,href=product_href, description=product_description.text, image=image_url,category="Smartgoggles",  
                    brand="Therabody" )
                db.session.add(smartgogglesProduct)
                db.session.commit()
                print(smartgogglesProduct)
